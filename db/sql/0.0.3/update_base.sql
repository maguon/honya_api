...
CREATE TABLE `storage_order` (
  ...
  `actual_fee` decimal(10,2) DEFAULT NULL COMMENT '实际支付费用',
...
-- ----------------------------
-- Table structure for storage_order_payment
-- ----------------------------
DROP TABLE IF EXISTS `storage_order_payment`;
CREATE TABLE `storage_order_payment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for storage_order_payment_rel
-- ----------------------------
DROP TABLE IF EXISTS `storage_order_payment_rel`;
CREATE TABLE `storage_order_payment_rel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `storage_order_id` int(10) NOT NULL COMMENT '仓储订单ID',
  `storage_order_payment_id` int(10) NOT NULL COMMENT '仓储订单支付ID',
  `created_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
